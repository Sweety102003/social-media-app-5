 ...
 return( <div className="card"  key={posts?._id}>
  <div className="card-header">
    <div className='card-pic'>
      <img src={posts.postedby.Photo? posts.postedby.Photo:profilelink} alt =""/>
    </div>
    <h5>
  ...
  <div className="card-image">
    ...
    {posts.photo.includes('image') ? (
                    <img src={posts.photo} alt="post" />
                ) : posts.photo.includes('video') ? (
                    <video controls>
                        <source src={posts.photo} type="video/mp4" />
